...
router.post("/subscription", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var foundUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_model_1.default.findOne({ _id: req.body._id })];
            case 1:
                foundUser = _a.sent();
                if (!foundUser) return [3 /*break*/, 3];
                return [4 /*yield*/, foundUser.update({
