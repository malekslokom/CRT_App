                  ...
                  >
                    <div class="flex items-center justify-start px-2">
                      ...
                      <div class="py-2 px-2">
                        ...
                        <select
                          id="desc"
                          class="focus:outline-none  text-red-700 text-base font-semibold fas fa-tint"
                          v-model="user.desc"
                        >
                          <option
                            class="text-base font-semibold"
                            :value="
                              user.sexe == 'Femme' ? 'Présidente' : 'Président'
                            "
                            >Président(e)</option
                          >
                          <option
                            class="text-base font-semibold"
                            value="Responsable jeunes"
                            >Responsable jeunes</option
                          >
                        </select>
      ...
      <div class="flex bg-green-200 max-w-sm mb-4">
        ...
        <div class="w-auto text-grey-700 items-center p-4">
          ...
          <p class="leading-tight">
            Responsable bien enregistrer.<br />
...
export default class AjouterResponsable extends Vue {
  NotifSucc = false;
  NotifFaild = false;
  add = {
    adresseNumero: "",
